...
<?php
  //tính tổng số dòng
  $tongSoDong = LibraryPage::pageing('intros');
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                            $ketqua = LibraryIntro::showIntro($offset, $row_count);
                                            while($arIntros = mysqli_fetch_assoc($ketqua)) {
                                                $intro_id = $arIntros['intro_id'];
                                                $slogan = $arIntros['slogan'];
                                                $content = $arIntros['content'];
                                                $picture = $arIntros['picture'];
                                        ?>
                                        <tr>
                                            <td><?php echo $intro_id ?></td>
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                ?>
                                                <img src="/templates/gshock/img/<?php echo $picture?>" alt="" height="100px" />
                                                <?php
                                                    }
                                                ?>
                                            </td>
                                            <td class="center">
                                                <a href="edit.php?id=<?php echo $intro_id?>" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
                                                <a href="del.php?id=<?php echo $intro_id?>" class="btn btn-danger"><i class="fas ion-edit"></i> Xóa</a>
                                            </td>
                                        </tr>
                                        <?php
                                        }
